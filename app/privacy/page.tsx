...
export const metadata = {
  title: "Privacy Policy - StreamX",
  description: "Privacy Policy for StreamX streaming platform",
};
          ...
          <LegalPage title="Privacy Policy">
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                <strong>No Account Required:</strong> StreamX does not
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Since StreamX has no user accounts or registration system, we
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                StreamX integrates with several external services:
              </p>
              ...
              <div className="mb-6">
                ...
                <p className="text-muted-foreground leading-relaxed mt-2">
                  <strong>Important:</strong> StreamX is not responsible for
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Since StreamX doesn't require accounts or collect personal
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                StreamX itself is completely ad-free. However, when you visit
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Since StreamX doesn't collect personal information from
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                github.com/PranavSagarXD/StreamX. As an open-source project, we're
