...
export const metadata = {
  title: "Terms of Service - StreamX",
  description: "Terms of Service for StreamX streaming platform",
};
          ...
          <LegalPage title="Terms of Service">
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                StreamX is released under the MIT License and is available on
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using StreamX, you accept and agree to be
                bound by these terms and conditions. If you do not agree with
                these terms, please do not use this service. Since StreamX
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                StreamX provides the following services:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Permission is granted to access StreamX for personal,
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                <strong>Important:</strong> StreamX links to external video
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                StreamX is not responsible for the content, practices, or
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                All movie and TV show information displayed on StreamX is
                sourced from:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                As a user of StreamX, you are responsible for:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                StreamX is provided "as is" without any warranties, expressed
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                StreamX and its contributors shall not be liable for any
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                use of StreamX after changes constitutes acceptance of the
                new terms.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                through our GitHub repository at github.com/PranavSagarXD/StreamX.
