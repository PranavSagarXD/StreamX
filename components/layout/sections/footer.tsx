      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            >
              ...
              />
              <h3 className="text-xl font-bold text-secondary">StreamX</h3>
            </Link>
            ...
            >
              <Link
                href="https://github.com/PranavSagarXD/StreamX"
                ...
                aria-label="StreamX GitHub repository"
                title="StreamX GitHub repository"
                target="_blank"
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
          <p className="text-sm text-muted-foreground">
            Pranav Sagar ✦ &copy; {new Date().getFullYear()} StreamX. All rights
            reserved.
          </p>
          <p className="text-sm text-muted-foreground">
            Made with{" "}
