...
export const metadata = {
  title: "DMCA Policy - StreamX",
  description:
    "DMCA Policy and Copyright Information for StreamX streaming platform",
};
          ...
          <LegalPage title="DMCA Policy">
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">
                About StreamX & Copyright
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                StreamX is a free, open-source movie and TV show discovery
                platform.{" "}
                <strong>
              ...
              <p className="text-muted-foreground leading-relaxed">
                All content information displayed on StreamX comes from The
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                StreamX respects intellectual property rights and complies
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                buttons on StreamX, they are directed to external,
                independent websites and video players (such as 2embed and
                others). These external sites:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>Are completely independent from StreamX</li>
                <li>
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                <strong>
                  StreamX is not responsible for content hosted on external
                  streaming sites.
                </strong>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                All movie and TV show information on StreamX comes from
                legitimate sources:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                StreamX infringe your copyright, please provide:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
            ...
            <section className="mb-8">
              ...
              <div className="bg-black/30 border border-white/20 rounded-lg p-6 mb-4">
                ...
                <p className="text-muted-foreground">
                  GitHub: github.com/PranavSagarXD/StreamX
                  <br />
                  Subject: "Copyright Inquiry - StreamX"
                </p>
              </div>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                While StreamX has no user accounts or user-generated content,
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                StreamX operates under fair use principles by:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                StreamX is open source software released under the MIT
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                StreamX and its contributors are not liable for:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4 mt-4">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                StreamX is available globally and respects international
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                GitHub repository at github.com/PranavSagarXD/StreamX. We are
