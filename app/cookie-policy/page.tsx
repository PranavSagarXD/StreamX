...
export const metadata = {
  title: "Cookie Policy - StreamX",
  description: "Cookie Policy for StreamX streaming platform",
};
      ...
      <div className="relative z-10 min-h-[100dvh] w-full">
        <ContentContainer className="w-full flex flex-col items-center">
          <LegalPage title="Cookie Policy">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-foreground mb-4">
                How StreamX Uses Cookies
              </h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
                StreamX uses cookies for essential functionality and
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                StreamX explicitly does NOT use:
              </p>
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mt-4">
                StreamX has no control over cookies used by external
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                If you disable cookies on StreamX:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
                <li>
